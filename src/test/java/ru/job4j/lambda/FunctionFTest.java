...
public class FunctionFTest {
    ...
    public void whenLinearFunctionThenLinearResults() {
        List<Double> result = FunctionF.diapason(5, 8, x -> 2 * x + 1);
    ...
    public void whenLinearFunctionThenQuadResults() {
        List<Double> result = FunctionF.diapason(2, 5, x -> x * x + 1);
    ...
    public void whenLinearFunctionThenExponentResults() {
        List<Double> result = FunctionF.diapason(3, 6, x -> Math.pow(2, x) + 1);
